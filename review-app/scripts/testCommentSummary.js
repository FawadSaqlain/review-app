// scripts/testCommentSummary.js
// Standalone tester for the local comment summarizer used by ratingApiController.summary
...
const samples = [
  'The instructor explained concepts clearly and was very helpful.',
  'Labs were useful and the course was well organized.',
  'Too many assignments and grading was slow. The TA was unresponsive.',
  'I enjoyed the lectures but found the midterm confusing.',
  'Project guidelines were unclear which caused issues for many teams.'
];
const summarizer = require('../lib/commentSummarizer');

console.log('=== Sample summary ===');
console.log(summarizer.summarizeComments(samples, 3.6, 78.5).summary);

// Export for reuse
module.exports = { summarizeComments: summarizer.summarizeComments };

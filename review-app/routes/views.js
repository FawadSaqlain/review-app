...
router.get('/admin/login', (req, res) => res.render('admin/admin-login', { title: 'Admin Login' }));
// Use manual class add page instead of timetable upload
router.get('/admin/class/add', adminRequire, (req, res) => res.render('admin/admin-add-class', { title: 'Add Class', user: req.user }));
